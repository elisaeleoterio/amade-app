...
interface RemoveProductBatchtModalProps {
  visible: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

export const RemoveProductBatchtModal = ({
  visible,
  onClose,
  onConfirm,
}: RemoveProductBatchtModalProps) => {
    ...
    >
      ...
      >
        <Pressable className="w-full max-w-sm rounded-[32px] bg-general-bg p-6 items-center shadow-lg relative">
          ...
          >
            Tem certeza que deseja remover esse(s) produto(s) do lote?
          </Text>
